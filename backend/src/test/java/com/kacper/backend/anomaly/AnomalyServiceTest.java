...
class AnomalyServiceTest {
    ...
    void notifExists_anomaly() {
        ...
        assertThat(response.measurement_ids()).containsExactlyInAnyOrder(1, 2);
    ...
    void noNotif_emptyResponse() {
        ...
        assertThat(response).isNotNull();
        assertThat(response.measurement_ids()).isEmpty();
    ...
    void uniqueMeasurement() {
        ...
        assertThat(response).isNotNull();
        assertThat(response.measurement_ids()).containsExactly(1);
    }
}
